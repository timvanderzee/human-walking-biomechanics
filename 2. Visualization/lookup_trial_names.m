...
% -------------------------------------------------------------------------
% trialnames = lookup_trial_names(trials)
% 
% returns a cell array with the trial descriptions (velocity and preferred
% walking speed or constant step length) for each trial in the input 
% variable 'trials'
%
% -------------------------------------------------------------------------
...
trialnames = cell(1,length(trials)); % emtpy cell
